...
import { getNestedValue, getValue, filterBy, setRefs } from '../../../../helpers/data/v0.0.2/data'
          ...
          case 'MultiSelect':
            column.filter = (
              <Box w={filterProps.props.width}>
                <MultiSelect
                  data={data?.[filterProps.valueField].map(item => ({ value: item.id, label: getValue(item, filterProps.labelField) }))}
