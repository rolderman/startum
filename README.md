...
## 2023-08-14 v0.6.1
### Доработки:
* Удаление фотографий при завершении уборки. Добавлено ограничение в фотографий и соответсвующее предупреждение.
### Исправленные баги:
* При сбросе фильтров в мобильной версии не сбрасывался диапозон дат и количество выбранных фильтров.
* Не корректный размер видео при фотографировании или сканировании QR.
* Не отоброжались данные о ЖК и объекте при первой загрузке в мобильной версии.
